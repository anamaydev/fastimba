...
import {Emmet, RelativeLines, Vim} from "@/components/icons";
  ...
  return (
    <div className={clsx(
      ...
      <div className="flex flex-col gap-0">
        ...
        <FeatureProvider>
          <Feature featureKey="vim">
            ...
            <Feature.Content>
              <Feature.Header>
                <Feature.Icon>
                  <Vim className="size-4 text-sapphire-300"/>
                </Feature.Icon>
        ...
        {/* Pomodoro */}
        <Pomodoro
          playButtonContainerRef={pomodoroPlayRef}
          restartButtonContainerRef={pomodoroRestartRef}
